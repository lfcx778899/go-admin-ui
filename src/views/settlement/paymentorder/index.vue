<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="purchasecontrolList">
      <el-table-column label="采购单号" prop="purchase_control_id" width="200"/>
  ...
  export default {
    ...
    data() {
      return {
        ...
        purchasecontrolList:[],
        orderStatusList:[
          {dictLabel: "已入库", dictValue: "3"},{dictLabel: "部分入库", dictValue: "4"},{dictLabel: "待付款", dictValue: "5"},{dictLabel: "已付款", dictValue: "6"}
        ]
      }
    },
    created() {
    ...
    methods: {
      ...
      handleQuery() {
        ...
        if(this.queryParams.page_status){
          ...
          this.queryParams.purchase_status ='3,4,5,6';
        }
        this.getList()
      },
      /** 重置按钮操作 */
